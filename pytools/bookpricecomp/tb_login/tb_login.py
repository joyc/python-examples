...
class TaoBao:
    def __init__(self):
        ...
        self.test_url = 'https://s.taobao.com/search?q=9787115428028&imgfile=&js=1&stats_click=search_radio_all%3A1&initiative_id=staobaoz_20190316&ie=utf8'
...
def spider(book_list=[]):
    """ 爬取淘宝网的图数数据 """
    html_data = taobao.login()
    selector = html.fromstring(html_data)
    # ul_list = selector.xpath('//div[@class="grid g-clearfix"]/div/dvi[@class="items"]')
    # # bk_list = html_data["API.CustomizedApi"]["itemlist"]["auctions"]
    print(html_data)
